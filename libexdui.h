...
// 参数<2>：nHeight
//======================================================
extern "C" int _imglist_create (int nWidth,int nHeight);
...
// 参数<4>：nIndexInsert
//======================================================
extern "C" int _imglist_add (int hImageList,int lpImage,int cbImage,int nIndexInsert);
...
// 参数<2>：nIndex
//======================================================
extern "C" void _imglist_del (int hImageList,int nIndex);
...
// 参数<2>：nIndex
//======================================================
extern "C" int _imglist_get (int hImageList,int nIndex);
...
// 参数<4>：cbImage
//======================================================
extern "C" void _imglist_set (int hImageList,int nIndex,int lpImage,int cbImage);
...
// 参数<1>：hImageList
//======================================================
extern "C" void _imglist_destroy (int hImageList);
...
// 参数<3>：pHeight
//======================================================
extern "C" void _imglist_size (int hImageList,int pWidth,int pHeight);
...
// 参数<3>：nIndexInsert
//======================================================
extern "C" int _imglist_addimage (int hImageList,int hImage,int nIndexInsert);
...
// 参数<3>：hImage
//======================================================
extern "C" void _imglist_setimage (int hImageList,int nIndex,int hImage);
...
//======================================================
// 函数名称：Ex_ObjEnablePaintingMsg
// 返回类型：逻辑型
// 参数<1>：hObj
// 参数<2>：bEnable
//======================================================
extern "C" BOOL Ex_ObjEnablePaintingMsg (int hObj,BOOL bEnable);

//======================================================
// 函数名称：Ex_ObjGetDropData
// 返回类型：整数型
// 函数说明：注意自行释放,0表示失败
// 参数<1>：hObj
// 参数<2>：pDataObject
...
// 参数<4>：pcbData
//======================================================
extern "C" int Ex_ObjGetDropData (int hObj,int pDataObject,int dwFormat,int pcbData);

//======================================================
// 函数名称：Ex_ObjGetDropString
// 返回类型：整数型
// 函数说明：返回长度,0表示失败
// 参数<1>：hObj
// 参数<2>：pDataObject
...
// 参数<4>：cchMaxLen
//======================================================
extern "C" int Ex_ObjGetDropString (int hObj,int pDataObject,int lpwzBuffer,int cchMaxLen);

//======================================================
// 函数名称：Ex_ObjCheckDropFormat
// 返回类型：逻辑型
// 函数说明：返回是否适用
// 参数<1>：hObj
// 参数<2>：pDataObject
// 参数<3>：dwFormat
//======================================================
extern "C" BOOL Ex_ObjCheckDropFormat (int hObj,int pDataObject,int dwFormat);

//======================================================
// 函数名称：_path_addbezier
// 返回类型：整数型
// 函数说明：添加贝塞尔
// 参数<1>：hPath
// 参数<2>：x1
...
// 参数<7>：y3
//======================================================
extern "C" int _path_addbezier (int hPath,float x1,float y1,float x2,float y2,float x3,float y3);

//======================================================
// 函数名称：_path_beginfigure3
// 返回类型：整数型
// 函数说明：开始新图形 v3
// 参数<1>：hPath
// 参数<2>：x，起始坐标
// 参数<3>：y，起始坐标
// 参数<4>：figureBegin，#PFB_  图形开始
//======================================================
extern "C" int _path_beginfigure3 (int hPath,float x,float y,int figureBegin);
